...
try{
var n=this;
if("txt"===n._msEditCore)
{
return f;
}
var p=getTop(),i=document.createElement('div'),o=document.createElement('div'),j=p.TE(['<a href="$jump$" target="_blank" notForEdit="true" attr-hasmapwrap="1">$img$</a>']),r,k,m,q,l,g;
i.style.display='none';
o.style.display='none';
document.body.appendChild(i);
i.innerHTML=f;
m=p.finds('img[ui-type="share_map"]',i);
for(var h=m.length-1;h>-1;--h)
{
k=m[h];
q=p.attr(k,"jump");
l=k.parentNode;
if(!(q&&/apis\.map\.qq\.com/i.test(q))||(l&&/^a$/i.test(l.tagName)&&p.attr(l,"attr-hasmapwrap")=="1"))
{
continue;
}
o.appendChild(k.cloneNode());
r=j.replace({jump:q,img:o.innerHTML});
o.innerHTML="";
p.replaceHTML(k,r);
g=true;
}
g&&(p.LogKV('insertmap|mapmailsend|kv'));
s=i.innerHTML;
p.removeSelf(o);
p.removeSelf(i);
}
...
QMEditor.CONST.FILES={"$js_path$webp//com/kits/qmeditor/qqmail/release/editor_toolbar270dbd.js":"Separate Bold Italic Underline FontName FontName FontSize ForeColor BackColor AlignMode Serial Indent Quot CreateLink SourceEdit Preview SpellCheck UploadEml FullScreen FormatMatch","$js_path$webp//com/kits/qmeditor/qqmail/release/editor_toolbar_plus2918f5.js":"ClipImg Photo ScreenSnap NetDisk Mo Word More Map"};
