...
namespace Property.UI
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // jQuery
            bundles.Add(new ScriptBundle("~/bundles/propertyCommon").Include(
                        "~/Scripts/jquerysession.js", "~/Scripts/common.js"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/validate").Include(
                      ...
                      "~/Scripts/plugins/validate/jquery.form.js",
                       "~/Scripts/validate/ValidateCommon.js"
                      ));
            ...
            bundles.Add(new ScriptBundle("~/plugins/fullCalendar").Include(
                      ...
                      "~/Scripts/plugins/fullcalendar/zh-cn.js"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/dataPicker").Include(
                      ...
                      "~/Scripts/plugins/datapicker/bootstrap-datepicker.zh-CN.js"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/d3").Include(
                      ...
                      "~/Scripts/plugins/d3/queue.v1.min.js",
                      "~/Scripts/plugins/d3/topojson.v1.min.js",
                      "~/Scripts/plugins/d3/d3map.js"));

            // 一次接线图
            bundles.Add(new ScriptBundle("~/plugins/conn").Include(
                      "~/Scripts/plugins/connection/pixi.js",
                      "~/Scripts/plugins/connection/iDrawer.js"));
